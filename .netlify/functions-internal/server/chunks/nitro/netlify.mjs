...
const _uh5ovZXuz8 = (function(nitro) {
...
const _lazy_JuSS6k = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_JuSS6k, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_JuSS6k, lazy: true, middleware: false, method: undefined }
];
